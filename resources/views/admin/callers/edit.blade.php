...
<div class="card mb-3">
    ...
    <div class="card-body">
        <form class="row" id="ediUser" method="POST" action="{{ route('admin.callers.edit', $caller['id']) }}"
           ...
           <div class="col-lg-6 mt-2">
                    ...
                    <input class="form-control" id="userId" placeholder="Enter UserId" name="userId" type="text"
                        value="{{ old('userId', $caller['userId']) }}" />
                    @error('userId')
                ...
                <div class="col-lg-6 mt-2">
                    ...
                    <input class="form-control" id="mobile" placeholder="Enter Mobile" name="mobile" type="tel"
                        value="{{ old('mobile', $caller['mobile']) }}" />
                    @error('mobile')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="col-lg-6 mt-2">
                ...
                <select name="status" class="form-select" id="status">
                    <option value="1" @selected(old('status', $caller['status'])==1)> Active </option>
                    <option value="0" @selected(old('status', $caller['status'])==0)> Inactive </option>
                </select>
                @error('status')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
            ...
            <div class="col-lg-6 mt-2">
                ...
                <div class="img-group mb-2">
                    <img class="" src="{{ asset('storage/' . $caller['image']) }}" alt="">
                </div>
